...
public class JF_home_mecanico extends JFrame {
	...
	public JF_home_mecanico() {
		...
		btnEditarOrden1.setBorder(new MatteBorder(1, 1, 1, 1, new Color(0, 0, 0)));
		...
		btnFacturaOrden1.setBorder(new MatteBorder(1, 1, 1, 1, new Color(0, 0, 0)));
		...
		btnHistorialOrden1.setBorder(new MatteBorder(1, 1, 1, 1, new Color(0, 0, 0)));
		...
		btnEditarOrden1_1.setBorder(new MatteBorder(1, 1, 1, 1, new Color(0, 0, 0)));
		...
		btnFacturaOrden1_1.setBorder(new MatteBorder(1, 1, 1, 1, new Color(0, 0, 0)));
		...
		btnHistorialOrden1_1.setBorder(new MatteBorder(1, 1, 1, 1, new Color(0, 0, 0)));
		...
		btnEditarOrden1_1_1.setBorder(new MatteBorder(1, 1, 1, 1, new Color(0, 0, 0)));
		...
		btnFacturaOrden1_1_1.setBorder(new MatteBorder(1, 1, 1, 1, new Color(0, 0, 0)));
		...
		btnHistorialOrden1_1_1.setBorder(new MatteBorder(1, 1, 1, 1, new Color(0, 0, 0)));
