...
import derrap.JF_Stock_Admin.ButtonEditor;
import derrap.JF_Stock_Admin.ButtonRenderer;
...
public class JF_Stock_Mecanico extends JFrame {
	...
	public JF_Stock_Mecanico(String ID) {
		selfFrame = this;
	...
	public void ActualizarTabla() {
		...
		table.setModel(new DefaultTableModel(stock,
				new String[] { "Código OEM", "Nombre", "Marca", "Cantidad", "Precio", "Estado", "Añadir Pieza"}));
	}
	...
	public void ActualizarTabla(String ID) {
		...
		table.setModel(new DefaultTableModel(stock,
				new String[] { "Código OEM", "Nombre", "Marca", "Cantidad", "Precio", "Estado", "Añadir Pieza"}));
		table.getColumn("Añadir Pieza").setCellRenderer(new ButtonRenderer1());
		table.getColumn("Añadir Pieza").setCellEditor(new ButtonEditor1(table,ID));
	}
	
	
	
	public static class ButtonRenderer1 extends JButton implements TableCellRenderer {
		...
		public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, boolean hasFocus, // ni
																															...
																															// esto
				int row, int column) {
			setText((value == null) ? "Añadir" : value.toString());
			return this;
		}
	}

	public static class ButtonEditor1 extends AbstractCellEditor implements TableCellEditor, ActionListener {
		...
		public ButtonEditor1(JTable table, String ID) {
			this.ID=ID;
			button = new JButton();
		...
		public void actionPerformed(ActionEvent e) {
			...
			JF_Cantidad_Piezas frame_cantidad_piezas = new JF_Cantidad_Piezas(ID,String.valueOf(value));
			frame_cantidad_piezas.setVisible(true);
			clicked = false;
			fireEditingStopped();
		}
