...
public class JF_ordenes extends JFrame {
	public JF_ordenes() {
		JFrame frame = new JFrame("Ejemplo JScrollPane para toda la página");
        ...
        for (int i = 1; i <= ordenes.size(); i++) {
    		...
    		panel.setBounds(10, 61*i, 580, 269);
    		...
    		lbTítuloOrden1.setBounds(10, 11*i, 193, 14);
    		...
    		lbDescripcionOrden1.setBounds(10, 25*i, 240, 14);
    		...
    		lbMatriculaOrden1.setBounds(10, 46*i, 240, 14);
    		...
    		lbTipoServicioOrden1.setBounds(10, 67*i, 240, 14);
    		...
    		lbIngresoTallerOden1.setBounds(10, 131*i, 410, 14);
    		...
    		lbProblemaVehiculoOrden1_1.setBounds(10, 92*i, 410, 28);
    		...
    		lblEstadoOrden1.setBounds(10, 156*i, 410, 14);
    		...
    		lbPiezasOrden1.setBounds(10, 181*i, 410, 40);
    		...
    		btnEditarOrden1.setBounds(490, 235*i, 80, 23);
    		...
    		btnFacturaOrden1.setBounds(400, 235*i, 80, 23);
    		...
    		btnHistorialOrden1.setBounds(230, 235*i, 160, 23);
