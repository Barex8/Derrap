...
public class JF_AñadirCliente extends JFrame {
	...
	public JF_AñadirCliente(Clientes_Admin frame,String DNI,String tabla) {										//Para modificar o eliminar
		...
		if(!tabla.equals("Proveedor")) result = login.conexion.consulta("Select * From "+tabla+" WHERE dni_"+tabla+" = " + "'"+DNI+"'");
		else result = login.conexion.consulta("Select * From "+tabla+" WHERE cif_"+tabla+" = " + "'"+DNI+"'");
		...
		EliminarCliente.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(success) {
					if(!tipoUsuario.equals("Proveedor"))login.conexion.DML("DELETE From derrap."+tabla+" where derrap."+tabla+".dni_"+tabla+" = "+"'"+info.get(0).getText()+"'");//Hay que mirar que los usuarios tienen coches asociados y por eso no se pueden borrar
					else login.conexion.DML("DELETE From derrap."+tabla+" where derrap."+tabla+".cif_"+tabla+" = "+"'"+info.get(0).getText()+"'");
	...
	public JF_AñadirCliente(Clientes_Admin frame,String tabla) {			//Se usa solo para Añadir
		...
		AñadirCliente.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				System.out.println(success);
				if(success) {
					if(tipoUsuario.equals("Cliente")) login.conexion.DML("INSERT INTO derrap."+tabla+" VALUES('"+datos[0]+"', '"+datos[1]+"' , '"+datos[2]+"', '"+datos[3]+"', '"+datos[4]+"', '"+datos[5]+"', '"+datos[6]+"', '"+datos[7]+"')");
					else if(tipoUsuario.equals("Usuario")) login.conexion.DML("INSERT INTO derrap."+tabla+" VALUES('"+datos[0]+"', '"+datos[7]+"' , '"+datos[1]+"', '"+datos[5]+"', '"+datos[4]+"', '"+datos[6]+"', '"+datos[3]+"', '"+datos[2]+"')");
					else if (tipoUsuario.equals("Proveedor")) login.conexion.DML("INSERT INTO derrap."+tabla+" VALUES('"+datos[0]+"', '"+datos[1]+"' , '"+datos[4]+"', '"+datos[2]+"' , '"+datos[3]+"')");
					frame.ActualizarTabla(tabla);
					dispose();
				}
			}
